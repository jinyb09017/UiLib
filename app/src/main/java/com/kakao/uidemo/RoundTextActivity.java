...
import com.kakao.uilib.round.RoundTextView;
import com.kakao.uilib.round.RoundViewDelegate;

public class RoundTextActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_round_text);
