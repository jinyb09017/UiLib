...
public class JMaterialDialog {
    ...
    private JMaterialDialog.Builder mBuilder;
    private View mView;
    ...
    public JMaterialDialog(Context context) {
    ...
    public JMaterialDialog setView(View view) {
        mView = view;
        if (mBuilder != null) {
    ...
    public JMaterialDialog setContentView(View view) {
     ...
     */
    public JMaterialDialog setContentView(int layoutResId) {
    ...
    public JMaterialDialog setBackground(Drawable drawable) {
    ...
    public JMaterialDialog setBackgroundResource(int resId) {
    ...
    public JMaterialDialog setTitle(int resId) {
        mTitleResId = resId;
        if (mBuilder != null) {
    ...
    public JMaterialDialog setTitle(CharSequence title) {
        mTitle = title;
        if (mBuilder != null) {
    ...
    public JMaterialDialog setMessage(int resId) {
        mMessageResId = resId;
        if (mBuilder != null) {
    ...
    public JMaterialDialog setMessage(CharSequence message) {
        mMessage = message;
        if (mBuilder != null) {
    ...
    public JMaterialDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        this.pId = resId;
    ...
    public JMaterialDialog setPositiveButton(String text, final View.OnClickListener listener) {
        this.pText = text;
        this.pListener = listener;
        return this;
    }
    ...
    public JMaterialDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        this.nId = resId;
    ...
    public JMaterialDialog setNegativeButton(String text, final View.OnClickListener listener) {
        this.nText = text;
        this.nListener = listener;
        return this;
    }
     ...
     */
    public JMaterialDialog setCanceledOnTouchOutside(boolean cancel) {
        this.mCancel = cancel;
        if (mBuilder != null) {
    ...
    public JMaterialDialog setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
