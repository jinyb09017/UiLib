...
import com.kakao.uilib.pop.JCustomPopWindow;
...
public class PopActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private JCustomPopWindow mJCustomPopWindow;
    private JCustomPopWindow mListPopWindow;
    private AppCompatSeekBar mAppCompatSeekBar;
    private JCustomPopWindow mPopWindow;
    @Override
    ...
    private void showPopBottom(){
        JCustomPopWindow popWindow = new JCustomPopWindow.PopupWindowBuilder(this)
    ...
    private void touchOutsideDontDisMiss(){
        ...
        mPopWindow = new JCustomPopWindow.PopupWindowBuilder(this)
                .setView(view)
    ...
    private void showPopTopWithDarkBg(){
        ...
        //创建并显示popWindow
        mJCustomPopWindow= new JCustomPopWindow.PopupWindowBuilder(this)
                .setView(contentView)
    ...
    private void useInAndOutAnim(){
        JCustomPopWindow popWindow = new JCustomPopWindow.PopupWindowBuilder(this)
                ...
                .setFocusable(true)
                .setOutsideTouchable(true)
                .setAnimationStyle(R.style.JCustomPopWindowStyle)
                .create()
    ...
    private void showPopListView(){
        ...
        //创建并显示popWindow
        mListPopWindow= new JCustomPopWindow.PopupWindowBuilder(this)
                .setView(contentView)
    ...
    private void handleLogic(View contentView){
        View.OnClickListener listener = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(mJCustomPopWindow!=null){
                    mJCustomPopWindow.dissmiss();
                }
                String showContent = "";
                switch (v.getId()){
                    case R.id.menu1:
                ...
                Toast.makeText(PopActivity.this,showContent,Toast.LENGTH_SHORT).show();
            }
        };
