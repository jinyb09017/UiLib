 ...
 * <p>
 * 用于显示年月日 2010-20-10 以及年月 2010-10
 */
public class DatePickerPopWin extends BasePopWindow implements OnClickListener {
    ...
    public static class Builder {
        ...
        public Builder timeFormate(String timeFormate) {
    ...
    public DatePickerPopWin(Builder builder) {
        ...
        this.timeFormate = builder.timeFormate;
    ...
    protected View getConView(Context context) {
        contentView = LayoutInflater.from(context).inflate(R.layout.layout_date_picker, null);
        return contentView;
    }
    ...
    private void initView() {
        ...
        yearLoopView = (LoopView) contentView.findViewById(R.id.picker_one);
        monthLoopView = (LoopView) contentView.findViewById(R.id.picker_two);
        dayLoopView = (LoopView) contentView.findViewById(R.id.picker_three);
    ...
    public static long getLongFromyyyyMMdd(String date) {
        SimpleDateFormat mFormat = new SimpleDateFormat(timeFormate, Locale.getDefault());
        Date parse = null;
        try {
    ...
    public static String getStrDate() {
        SimpleDateFormat dd = new SimpleDateFormat(timeFormate, Locale.CHINA);
