package com.kakao.uilib.widget;
...
public class TagLayout extends ViewGroup {
    ...
    public TagLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            horizontalSpacing = (int) a.getDimension(R.styleable.LabelLayout_horizontalSpacing, dp2px(8.0f));
            verticalSpacing = (int) a.getDimension(R.styleable.LabelLayout_verticalSpacing, dp2px(4.0f));

            checkboxLayoutId = a.getResourceId(R.styleable.LabelLayout_checkboxLayout, R.layout.view_label_common);
            enableDivider = a.getBoolean(R.styleable.LabelLayout_enableDivider, false);
            dividerHeight = a.getDimension(R.styleable.LabelLayout_dividerHeight, dp2px(2));
            dividerColor = a.getColor(R.styleable.LabelLayout_dividerColor, 0xffECECEC);
        } finally {
            a.recycle();
        }
    }
...
//            System.out.println("measured height:" + height);
     ...
     *
     * @param labels A collection contains objects that implement PickerItem interface.
     */
    public void setLabels(List<? extends PickerItem> labels) {
        labelcheckMap.clear();
        removeAllViews();
        if (labels == null || labels.size() == 0) return;
        for (final PickerItem label : labels) {
    ...
    public interface OnCheckChangeListener {
        void onCheckChanged(PickerItem label, boolean isChecked);
