 ...
 * doc:https://github.com/pinguo-zhouwei/CustomPopwindow
 *
 * //设置setBackgroundDrawable的原因参照http://www.jianshu.com/p/825d1cc9fa79
 *
 *  解决android手机api>23的时候，如果height为match_parent的时候，showAsDropDown（showAtLocation也不起作用了）失效，并且会填充全部屏幕的问题。
 *  参照SFPopupWindow
 */

public class JCustomPopWindow implements PopupWindow.OnDismissListener{
    private static final String TAG = "JCustomPopWindow";
    ...
    private JCustomPopWindow(Context context){
        mContext = context;
    }
     ...
     * @return
     */
    public JCustomPopWindow showAsDropDown(View anchor, int xOff, int yOff){
    ...
    public JCustomPopWindow showAsDropDown(View anchor){
        if(mPopupWindow!=null){
    ...
    public JCustomPopWindow showAsDropDown(View anchor, int xOff, int yOff, int gravity){
        if(mPopupWindow!=null){
     ...
     * @return
     */
    public JCustomPopWindow showAtLocation(View parent, int gravity, int x, int y){
        if(mPopupWindow!=null){
    ...
    private PopupWindow build(){
        ...
        if(!enableOutsideTouchDisMiss){
            ...
            //设置background的原因参照http://www.jianshu.com/p/825d1cc9fa79
            ...
            //在Android 6.0以上 ，只能通过拦截事件来解决（直接消费掉事件）
    ...
    public static class PopupWindowBuilder{
        private JCustomPopWindow mCustomPopWindow;

        public PopupWindowBuilder(Context context){
            mCustomPopWindow = new JCustomPopWindow(context);
        }
        ...
        public JCustomPopWindow create(){
            //构建PopWindow
